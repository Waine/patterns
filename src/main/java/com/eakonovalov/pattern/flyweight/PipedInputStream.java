...
public class PipedInputStream extends InputStream {
    ...
    private static final int DEFAULT_PIPE_SIZE = 1024 * 1000;
    /**
    ...
    protected synchronized void receive(byte b[], int off, int len) throws IOException {
        ...
        while (bytesToTransfer > 0) {
            ...
            if (l != null && len > 0) l.onReceived(this, len);
        }
    }
    ...
    public void setInputStreamListener(InputStreamListener l) {
        this.l = l;
    }
    ...
    public boolean equals(Object o) {
        ...
        PipedInputStream that = (PipedInputStream) o;
